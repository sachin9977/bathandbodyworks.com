...
function SignupLogin() {
  ...
  return (
    <div>
      ...
      <Text marginBottom="10px" fontSize="22" paddingX="40" align="start">
        Sign In or Sign Up
      </Text>
      ...
      >
        <Box display="block">
          ...
          <Input required pr="4.5rem" type="email" placeholder="Enter Email" />
          <Spacer h="20px" />
          ...
          <Box display="flex" justifyContent="space-evenly">
            <Text fontSize="14" decoration="underline">
              Forgot Password?
            </Text>
            <Box display="flex">
              <Checkbox></Checkbox>
              <Text marginLeft="4px" fontSize="14">
                Remember Me
              </Text>
            </Box>
          </Box>
        ...
        <Box align="center">
          ...
          <Image
            width="350px"
            src="https://cdn-fsly.yottaa.net/5d669b394f1bbf7cb77826ae/www.bathandbodyworks.com/v~4b.219/on/demandware.static/-/Sites-BathAndBodyWorks-Library/default/dw0f47b7b9/images/loyalty/boc-launch-prospects_lacb_0.jpg?yocs=s_"
          ></Image>
          <br />
          <Button
            fontSize="14"
